...
#ifndef INPUT_EVENTS_ADAFRUIT_FT6206_TOUCH_SCREEN_ADAPTER_H
#define INPUT_EVENTS_ADAFRUIT_FT6206_TOUCH_SCREEN_ADAPTER_H
...
/**
 * @brief Concrete implementation of BaseTouchScreenAdapter for Adafruit's FT6206 TouchScreen class.
 * 
 ...
 * 
 */
class AdafruitFT6206TouchScreenAdapter : public BaseTouchScreenAdapter {
...
public:
     ...
     */
    AdafruitFT6206TouchScreenAdapter(uint8_t thresh = FT62XX_DEFAULT_THRESHOLD,
    ...
    /**
     * @brief Get the raw TouchPoint_s struct containing X/Y values directly from the underlyig library.
     * 
     ...
     * @return TouchPoint_s 
     */
    TouchPoint_s getTouchPointRaw() {
        TS_Point p = ctp.getPoint();
        return TouchPoint_s(p.x, p.y, p.z);
    }
